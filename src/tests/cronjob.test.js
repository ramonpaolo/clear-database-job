...
describe('CronJob', () => {
  ...
  it('transform seconds unit into milliseconds', (context) => {
    const cronJob = {
      time: 1,
      unit: 'seconds',
    }
  ...
  it('transform minutes unit into milliseconds', (context) => {
    const cronJob = {
      time: 1,
      unit: 'minutes',
    }
  ...
  it('transform hours unit into milliseconds', (context) => {
    const cronJob = {
      time: 1,
      unit: 'hours',
    }
  ...
  it('transform days unit into milliseconds', (context) => {
    const cronJob = {
      time: 1,
      unit: 'days',
    }
  ...
  it('transform months unit into milliseconds', (context) => {
    const cronJob = {
      time: 1,
      unit: 'months',
    }
  ...
  it('transform years unit into milliseconds', (context) => {
    const cronJob = {
      time: 1,
      unit: 'years',
    }
